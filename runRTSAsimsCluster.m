function runRTSAsims()
%runRTSAsims Summary of this function goes here
%   Detailed explanation goes here


%% Set-up
model_file = 'FSModel_GHJoint_Z94byi642sy.osim';
rhash = 'Z99aaa111bb'
task_name = 'HairTouch'
...
solver.setGuessFile(['initial_guess_' task_name '_RC_0.sto'])
%% Solve
disp('I''m running')
tic;
...
solution_file = ['..\' print_folder_name '\MocoSol_' task_name '.sto'];

predicted_solution.write(solution_file);
